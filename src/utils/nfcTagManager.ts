...
export const DEMO_PRODUCTS: NFCProductData[] = [
  {
    ...
    price: 25000, // 25,000 KRW in wei equivalent (25000 * 10^18)
    currency: 'KRW',
  ...
  {
    productId: 'coffee-cappuccino-003',
    name: 'Classic Cappuccino',
    price: 30000, // 30,000 KRW
    currency: 'KRW',
    description: 'Traditional Italian cappuccino with foam art',
